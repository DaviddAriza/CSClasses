...
# create objects as needed in setup or other places 
    ...
    def test_002_point_equality(self):
        ...
        self.assertFalse(self.one_above_origin == self.one_under_origin)
        self.assertTrue(self.origin == self.origin)

    #TODO! Implement this 
    def test_003_sphere_area(self):
        self.assertEqual(self.one_radius_sphere.area(),math.pi * 4)
        self.assertEqual(self.ten_radius_sphere.area(),math.pi * 4 * 100)

    
    #TODO! Implement this 
    def test_004_sphere_volume(self):
        self.assertEqual(self.one_radius_sphere.volume(),math.pi * 4/3)
        self.assertEqual(self.ten_radius_sphere.volume(),math.pi * 4/3 * 1000)
    ...
    def test_005_sphere_is_inside_point(self):
        ...
        self.assertTrue(self.ten_radius_sphere.is_inside_point(self.origin))
    ...
    def test_006_sphere_is_inside_sphere(self):
        ...
        self.assertFalse(self.one_radius_sphere.is_inside_sphere(self.one_radius_sphere))
   ...
   #TODO! Implement this 
    def test_006_cube_is_inside_point(self):
        ...
        self.assertFalse(self.one_cube.is_inside_point(self.one_under_origin))
        self.assertFalse(self.one_cube.is_inside_point(self.out_point))
        
        self.assertTrue(self.ten_cube.is_inside_point(self.origin))
        self.assertTrue(self.ten_cube.is_inside_point(self.one_above_origin))
        self.assertTrue(self.ten_cube.is_inside_point(self.one_under_origin))
...
# You need to implement the method is_inside_cube()
    def test_000_is_inside_cube(self):
        self.assertTrue(self.ten_cube.is_inside_cube(self.one_cube))
